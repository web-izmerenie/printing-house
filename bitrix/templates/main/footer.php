...
<?if($_SERVER[ 'REQUEST_URI'] !='/404.php' ){?>
	<?if($_SERVER[ 'REQUEST_URI']=='/detail_item.php' ){?>
		<section class="technology_module">
			...
			<ul>
				<li>
					<a href="#"><img src="/upload/tech1.jpg"><span>Офсетная печать</span>
					</a>
				</li>
				<li>
					<a href="#"><img src="/upload/tech2.jpg"><span>Цифровая печать</span>
					</a>
				</li>
				<li>
					<a href="#"><img src="/upload/tech3.jpg"><span>Трафаретная печать</span>
					</a>
				</li>
				<li>
					<a href="#"><img src="/upload/tech4.jpg"><span>Ламинирование</span>
					</a>
				</li>
				<li>
